...
<head>
    ...
    <link rel="stylesheet" href="/View/style/smartbike.css">
</head>

<body>
    <!-- En-tête de page contenant le logo et les différents liens du site Smartbike -->
    <header class="smartbike-header">
        <!-- Logo de l'enseigne -->
        <a href="/index.php" class="smartbike-logo">
            <strong>SmartBike</strong>
        </a>
